...
export function AuroraBackground() {
  ...
  return (
    <div className="fixed inset-0 -z-10 overflow-hidden bg-bg">
      ...
      <div
        className="absolute -top-48 -start-40 h-[42rem] w-[42rem] rounded-full blur-3xl animate-drift-slow"
        style={{
      ...
      <div
        className="absolute top-1/2 -end-48 h-[38rem] w-[38rem] rounded-full blur-3xl animate-drift-slower"
        style={{
